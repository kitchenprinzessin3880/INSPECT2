...
public class GetStationsEvent extends
    ...
    //ASD
    private boolean isSearchByTheme = false;
     ...
     */
    public GetStationsEvent(String sosURL, BoundingBox bbox, boolean searchByTheme,
            GetStationsEventHandler... blockedHandlers) {
        super(blockedHandlers);
        this.sosURL = sosURL;
        this.bbox = bbox;
        this.isSearchByTheme = searchByTheme;
    }
    ...
    public boolean isSearchByTheme() {
		return isSearchByTheme;
	}

	public void setSearchByTheme(boolean isSearchByTheme) {
		this.isSearchByTheme = isSearchByTheme;
	}
