...
public class StoreStationsEvent extends
    ...
    //ASD
    private boolean isThemeSearch = false;

    public boolean isThemeSearch() {
		return isThemeSearch;
	}
     ...
     */
    public StoreStationsEvent(String sosURL, List<Station> stations, String srs,boolean themeSearch,
            StoreStationsEventHandler... blockedHandlers) {
        super(blockedHandlers);
        this.sosURL = sosURL;
        this.stations = stations;
        this.srs = srs;
        this.isThemeSearch = themeSearch;
    }
