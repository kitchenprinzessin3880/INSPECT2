...
public class OverviewPresenter {
     ...
     */
    public OverviewPresenter(GenericWidgetView overviewWidgetView, HandlerManager ovhandlerManager,
            HandlerManager mainDependantHandlerManager) {
        Validate.notNull(ovhandlerManager);
        this.overviewWidgetView = Validate.notNull(overviewWidgetView);

        addDependantHandlerManager(mainDependantHandlerManager);

        OverviewPresenterEventHandler eventHandler = new OverviewPresenterEventHandler();
        ovhandlerManager.addHandler(ViewportDragInProgressEvent.TYPE, eventHandler);
        ovhandlerManager.addHandler(ViewportDragFinishedEvent.TYPE, eventHandler);
        ovhandlerManager.addHandler(SetDomainBoundsEvent.TYPE, eventHandler);
        ovhandlerManager.addHandler(SetMaxDomainBoundsEvent.TYPE, eventHandler);
        ovhandlerManager.addHandler(SetOverviewDomainBoundsEvent.TYPE, eventHandler);
        ovhandlerManager.addHandler(SetViewportPixelBoundsEvent.TYPE, eventHandler);
    ...
    private class OverviewPresenterEventHandler implements ViewportDragInProgressEventHandler,
        ...
        public void onDragFinished(ViewportDragFinishedEvent event) {
        	//ASD - disable slider
        	OverviewPresenter.this.setHorizontallyLocked(true);
