...
public class GetOfferingEvent extends FilteredDispatchGwtEvent<GetOfferingEventHandler>{
	...
	private boolean isAllOfferingBySOS = false;
	
	public boolean isAllOfferingBySOS() {
		return isAllOfferingBySOS;
	}

	public void setAllOfferingBySOS(boolean isAllOfferingBySOS) {
		this.isAllOfferingBySOS = isAllOfferingBySOS;
	}
	...
	public GetOfferingEvent(String serviceURL, boolean offReqMode) {
		this.serviceURL = serviceURL;
		this.isAllOfferingBySOS = offReqMode;
	}
