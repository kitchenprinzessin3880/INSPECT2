...
public class DragImageControl {
    ...
    public DragImageControl(HandlerManager handlerManager) {
        ...
        //ASD
        handlerManager.addHandler(SetQualityControlStatusEvent.TYPE, eventHandler);
	...
	public void onSetQualityControlStatus(SetQualityControlStatusEvent evt) {
		...
		this.isQualityControlSelected = evt.getQCStatus();
	}

    private void onDragFinished(ViewportDragFinishedEvent event) {
    	//ASD
        if (this.active && !this.isQualityControlSelected) {
    ...
    private class DragImageControlEventHandler implements ViewportDragInProgressEventHandler,
            ViewportDragFinishedEventHandler, SetDomainBoundsEventHandler, SetMaxDomainBoundsEventHandler, SetQualityControlStatusEventHandler {
		...
		public void onSetQualityControlStatus(SetQualityControlStatusEvent evt) {
			// TODO Auto-generated method stub
			 DragImageControl.this.onSetQualityControlStatus(evt);
		}
    }
