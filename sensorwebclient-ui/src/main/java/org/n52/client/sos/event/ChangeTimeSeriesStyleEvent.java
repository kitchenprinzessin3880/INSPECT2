...
public class ChangeTimeSeriesStyleEvent extends
    ...
    //private boolean isResetColors= false;


	/*ASD 28.07.2014
    public ChangeTimeSeriesStyleEvent(boolean isResetCol) {
    	this.isResetColors = isResetCol;
    } */
    /**
    ...
    //ASD 17.09.2014
    public ChangeTimeSeriesStyleEvent(String ID, String hexColor, double opacPerc,String style) {
        this.ID = ID;
        this.hexColor = hexColor;
        this.opacPerc = opacPerc;
        this.style = style;
    ...
    /*
    public boolean isResetColors() {
		return isResetColors;
	}
	public void setResetColors(boolean isResetColors) {
		this.isResetColors = isResetColors;
	}*/
}
