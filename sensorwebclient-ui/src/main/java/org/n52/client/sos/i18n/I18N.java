...
public interface I18N extends Constants {
	...
	String qualityFlagging();
	
	String qualityFlaggingRange();
	
	String qualityFlaggingPoint();
	
	String qualityFlaggingRule();
	
	String qualityFlaggingView();
	
	String qualityFlaggingWindow();
