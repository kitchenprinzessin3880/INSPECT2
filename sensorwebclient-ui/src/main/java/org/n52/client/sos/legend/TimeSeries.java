...
public class TimeSeries implements LegendData {
	...
	//ASD 17.09.2014
	public void setCustomScale(boolean customScale, double min, double max) {
		this.properties.setCustomScale(customScale);
		this.properties.setCustomScaleMin(min);
		this.properties.setCustomScaleMax(max);
	}

	public boolean isCustomScale() {
		return this.properties.isCustomScale();
	}
