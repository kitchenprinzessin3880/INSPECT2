...
public final class Application {
	...
	public static void continueStartup() {
		...
		QualityFlaggingController.getInstance();
	...
	public static void finishStartup() {
		//ASD 13.11.2014
		EventBus.getMainEventBus().fireEvent(new GetQualityCodeEvent());
	...
	public static void showStationSelectorWhenConfigured() {
		PropertiesManager properties = PropertiesManager.getInstance();
		boolean showAtStartup = properties.getParameterAsBoolean("showStationSelectorAtStartup");
		String redirect = PropertiesManager.getInstance().getParameterAsString("redirectUrl");
		if (showAtStartup) {
	...
	private static boolean isAllParametersAvailable(String[] serviceUrls, String[] versions, String[] offerings, String[] fois, String[] procedures, String[] phenomenons) {
