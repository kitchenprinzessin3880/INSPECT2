...
public class View {
	...
	// ASD
	private Header headerInstance = null;
	...
	private VLayout createLayoutStack() {
		...
		/*
		 * VLayout lay = new VLayout(); lay.setBackgroundColor("#015d9e");
		 * lay.setHeight(5);
		 */
		vLayout.addMember(getDefaultHeader());
	...
	private Canvas getDefaultHeader() {
		// ASD
		headerInstance = new Header("header");
	...
	public DataPanel getDataPanel() {
		...
		// ASD
		datapanel.setDragAppearance(DragAppearance.OUTLINE);
		return datapanel;
	}
	...
	public void setHeaderInstance(Header headerInstance) {
