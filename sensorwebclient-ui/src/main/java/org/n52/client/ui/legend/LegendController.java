...
public class LegendController {
	...
	private class LegendControllerEventBroker implements 
				...
				DeleteTimeSeriesEventHandler,DeleteAllTimeSeriesEventHandler {
		...
		LegendControllerEventBroker(LegendController legendController) {
			...
			eventBus.addHandler(DeleteAllTimeSeriesEvent.TYPE, this);
		...
		public void onFinishedLoadingTimeSeries(
			...
			if(DataManagerSosImpl.getInst().isUserHasLoggedIn())
			{
				legend.setQualityButtonActiv(true);
			}
		}
		...
		public void onDeleteTimeSeries(DeleteTimeSeriesEvent evt) {
			...
			if (timeseries.length < 1) {
				...
				legend.setQualityButtonActiv(false);
			}
