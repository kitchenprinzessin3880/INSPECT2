...
public class DesignOptions implements Serializable {
    ...
    private LinkedHashMap<String,ArrayList<String>> selectedCoord = null;
    
    private boolean isQCActive = false;
   ...
   /* public DesignOptions(ArrayList<TimeSeriesProperties> props, long begin, long end, String timeParam, boolean grid,Map<String,ArrayList<String>> XYCoord,boolean qcChk) {
        this(props, begin, end, grid, XYCoord, qcChk);
        this.timeParam = timeParam;

    }*/
    
    public DesignOptions(ArrayList<TimeSeriesProperties> props, String selectedId, long begin, long end, boolean grid, LinkedHashMap<String,ArrayList<String>> map, boolean qc) {
        if (props.isEmpty()) {
            throw new IllegalArgumentException("Cannot create DesignOptions from empty TimeSeriesProperties list.");
        }
        this.properties = props;
        ...
        this.width = props.get(0).getWidth();
        this.language = props.get(0).getLanguage();
        this.selectedCoord= map;
        this.isQCActive=qc;
        this.selectedSeriesId= selectedId;
    }
    ...
    //ASD
    public HashMap<String, String> getAllPhenomenaWihtUOM() {
        HashMap<String, String> obs = new HashMap<String, String>();
        for (TimeSeriesProperties p : this.properties) {
            String phenomenon = p.getPhenomenon().getId();
            String uom = p.getPhenomenon().getUnitOfMeasure();
            obs.put(phenomenon, uom);
        }
        return obs;
    }
    ...
    public boolean isQCActivated() {
        return this.isQCActive;
    }
    
    public LinkedHashMap<String,ArrayList<String>> getSelectedCoordinates() {
        return this.selectedCoord;
    }

    public String printOptionsWithQC() {
        StringBuilder sb = new StringBuilder("QCOptions [");
        sb.append("begin: ").append(new Date(begin)).append(", ");
        sb.append("end: ").append(new Date(end)).append(", ");
        sb.append("height: ").append(height).append(", ");
        sb.append("width: ").append(width).append(", ");
        sb.append("selected coordinate: ").append(selectedCoord.toString()).append(", ");
        sb.append("language: ").append(language).append(" ");
        sb.append("isQCActivated: ").append(isQCActive).append("]");
        return sb.toString();
    }
