...
public class TimeSeriesProperties implements Serializable {
	...
	private boolean isCustomScale = false;
	private double customScaleMin =0.0;
	private double customScaleMax =0.0;
	...
	public TimeSeriesProperties(String sosUrl, Station station, Offering offering,
		...
		this(sosUrl, station, offering, foi, procedure, phenomenon, width, height, "", true, color);
	}
	...
	public TimeSeriesProperties(String sosUrl, Station station, Offering offering,
			FeatureOfInterest foi, Procedure procedure, Phenomenon phenomenon,
			int width, int height, String uom, boolean isAutoScale, String color) {
		this.sosUrl = sosUrl;
	...
	public void setValidTime(Long firstValue, Long lastValue) {
	...
	public void setCustomScale(boolean isCustomScale) {
		this.isCustomScale = isCustomScale;
	}
