...
/*
  ...
  Version SC_SNAPSHOT-2011-12-05/LGPL Development Only (2011-12-05)
...
*/
if(typeof isomorphicDir == 'undefined'){isomorphicDir = 'client/sc/';}
...
);isc.evalBoundary;isc.B.push(isc.A.getHSnapOrigin=function isc_Canvas_getHSnapOrigin(_1){return this.HSnapOrigin?this.HSnapOrigin:0}
...
);isc.evalBoundary;isc.B.push(isc.A.getViewportRatio=function isc_Canvas_getViewportRatio(_1){if(_1){return this.getViewportHeight()/this.getScrollHeight()}else{return this.getViewportWidth()/this.getScrollWidth()}}
...
);isc.evalBoundary;isc.B.push(isc.A.$k2=function isc_Canvas__updateCursor(){var _1=this.getCurrentCursor();if(this.$v9==_1)return;this.$v8(_1)}
