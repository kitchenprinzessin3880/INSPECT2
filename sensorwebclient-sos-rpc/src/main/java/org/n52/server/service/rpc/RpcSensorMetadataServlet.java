...
public class RpcSensorMetadataServlet extends RemoteServiceServlet implements RpcSensorMetadataService {
    ...
    public SensorMetadataResponse getSensorMetadata(TimeSeriesProperties tsProperties,long start, long end) throws Exception {
        ...
        return service.getSensorMetadata(tsProperties, start,  end);
    }
	...
	public SensorMetadataResponse getMultipleSensorMetadata(List<TimeSeriesProperties> properties,long start, long end) throws Exception {
		...
		Statistics.saveHostRequest(this.getThreadLocalRequest().getRemoteHost());
        return service.getMultipleSensorMetadata(properties, start, end);
	}

	@Override
	public SensorMetadataResponse getMaintenanceDetails(List<String> sensors, long start, long end) throws Exception {
		Statistics.saveHostRequest(this.getThreadLocalRequest().getRemoteHost());
		return service.getMaintenanceDetails(sensors,start,end);
	}
}
